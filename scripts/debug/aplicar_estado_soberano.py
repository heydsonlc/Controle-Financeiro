...
with app.app_context():
    ...
    with db.engine.connect() as conn:
        try:
            ...
            print("[OK] Coluna 'saldo_devedor_atual' adicionada")
        except Exception as e:
            if "duplicate column name" in str(e).lower():
                print("[AVISO]  Coluna 'saldo_devedor_atual' já existe")
            else:
                raise
        ...
        try:
            ...
            print("[OK] Coluna 'numero_parcela_base' adicionada")
        except Exception as e:
            if "duplicate column name" in str(e).lower():
                print("[AVISO]  Coluna 'numero_parcela_base' já existe")
            else:
                raise
        ...
        try:
            ...
            print("[OK] Coluna 'data_base' adicionada")
        except Exception as e:
            if "duplicate column name" in str(e).lower():
                print("[AVISO]  Coluna 'data_base' já existe")
            else:
                raise
        ...
        try:
            ...
            print("[OK] Coluna 'amortizacao_mensal_atual' adicionada")
        except Exception as e:
            if "duplicate column name" in str(e).lower():
                print("[AVISO]  Coluna 'amortizacao_mensal_atual' já existe")
            else:
                raise
        ...
        try:
            ...
            print("[OK] Coluna 'regime_pos_amortizacao' adicionada")
        except Exception as e:
            if "duplicate column name" in str(e).lower():
                print("[AVISO]  Coluna 'regime_pos_amortizacao' já existe")
            else:
                raise
    ...
    for fin in financiamentos:
        ...
        if fin.sistema_amortizacao == 'SAC':
            fin.amortizacao_mensal_atual = fin.valor_financiado / Decimal(fin.prazo_total_meses)

        print(f"  [OK] Financiamento '{fin.nome}' (ID={fin.id}) inicializado")
        print(f"     Saldo: R$ {fin.saldo_devedor_atual:,.2f}")
        if fin.amortizacao_mensal_atual:
    ...
    print("="*80)
    print("[OK] Colunas adicionadas")
    print("[OK] Estado soberano inicializado")
    print("\n")
