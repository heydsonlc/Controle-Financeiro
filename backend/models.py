...
class FinanciamentoSeguroVigencia(db.Model):
    ...
    def to_dict(self):
        return {
            ...
            'saldo_devedor_vigencia': float(self.saldo_devedor_vigencia) if self.saldo_devedor_vigencia is not None else None,
            'taxa_percentual': float(self.taxa_percentual) if self.taxa_percentual is not None else None,
